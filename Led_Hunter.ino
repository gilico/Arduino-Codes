...
int valX = 0;
int valY = 0;
int ledsX[Arr_size]= {RedLed, GreenLed, NoLed};
int ledsY[Arr_size]= {BlueLed, YellowLed, NoLed};
bool isLedXOff[Arr_size] = {false, false};
bool isLedYOff[Arr_size] = {false, false};
